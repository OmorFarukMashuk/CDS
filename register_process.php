<?php
    ...
    $query = "INSERT INTO users(first,last,dob,address,district,gender,phone,email,pass)
    VALUES('$firstname','$lastname','$dob','$houseaddress','$district', '$gender','$Phone','$email','$password')";
