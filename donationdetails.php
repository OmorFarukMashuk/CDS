...
$result=mysql_query("select * from inventory where mod_id='$sid' and status='done'") 
...
echo "</table>";
  $result1=mysql_query("select * from inventory where mod_id='$sid' and status='pending'") 
or die("failed to query from inventory".mysql_error());
